...
class ObsidianAnalyzer:
    ...
    def __init__(self, vault_path: str, exclude_folders: List[str] = None, exclude_notes: List[str] = None):
    ...
    def get_statistics(self) -> Dict:
        ...
        bidirectional_links = sum(
            1 for note in self.notes.values()
    ...
    def search_notes(self, query: str = None, tags: List[str] = None, 
                     min_links: int = None, max_links: int = None) -> List[Note]:
        """搜索笔记
        ...
        if query:
            ...
            results = [
                ...
                if query_lower in note.name.lower() or query_lower in note.content.lower()
            ]
...
class MultiVaultAnalyzer:
    ...
    def __init__(self, vault_paths: List[str], exclude_folders: List[str] = None, 
    ...
    def get_combined_statistics(self) -> Dict:
        ...
        total_words = sum(
            sum(n.word_count for n in a.notes.values()) 
